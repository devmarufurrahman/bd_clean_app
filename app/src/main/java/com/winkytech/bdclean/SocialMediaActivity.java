...
public class SocialMediaActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        post_approve = findViewById(R.id.post_approve);
                ...
                try {
                    ...
                    for (int i=0; i< jsonArray.length(); i++){
                        ...
                        if (approve_status.equals("1")){
                            approvePostLists.add(postApprove);

                        }

                        String totalApprovePost = String.valueOf(approvePostLists.size());

                        post_approve.setText("My Approve Post("+ totalApprovePost+")");
                ...
                if (putData.startPut()) {
                    if (putData.onComplete()) {
                        ...
                        if (result.equals("success")){
                            ...
                            toast.setDuration(Toast.LENGTH_SHORT);
                            toast.show();
                            Log.d("error", "error" + putData.getThreadGroup());
                        }
                    }
                }
