...
public class HomeActivity extends AppCompatActivity {
    ...
    LinearLayout manage_post, activity_log, my_activity, manage_events, member_status, chat_button,social_media, voting, complain, evaluation, events, member_layout, chat_layout, message_layout, notice_layout, manage_notice_layout;
